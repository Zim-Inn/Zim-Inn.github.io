...
const LoadDeckFunc = function (skipHistory, deckCode) {
    ...
    if (DecodedDeck) {
        ...
        document.getElementById("DeckViewerBoxChartR").outerHTML =
            '<div id="DeckViewerBoxChartR" class="DeckViewerCardColourBoxChartInner DeckViewerCardManaColouringR" onmousemove="ShowTextTooltip(1, \'' +
            TotalR +
            ' Red Cards\');" onmouseout="ShowTextTooltip(0,0);">' +
            TotalR +
            "</div>";
        document.getElementById("DeckViewerBoxChartU").outerHTML =
            '<div id="DeckViewerBoxChartU" class="DeckViewerCardColourBoxChartInner DeckViewerCardManaColouringU" onmousemove="ShowTextTooltip(1, \'' +
            TotalU +
            ' Blue Cards\');" onmouseout="ShowTextTooltip(0,0);">' +
            TotalU +
            "</div>";
        document.getElementById("DeckViewerBoxChartB").outerHTML =
            '<div id="DeckViewerBoxChartB" class="DeckViewerCardColourBoxChartInner DeckViewerCardManaColouringB" onmousemove="ShowTextTooltip(1, \'' +
            TotalB +
            ' Black Cards\');" onmouseout="ShowTextTooltip(0,0);">' +
            TotalB +
            "</div>";
        document.getElementById("DeckViewerBoxChartG").outerHTML =
            '<div id="DeckViewerBoxChartG" class="DeckViewerCardColourBoxChartInner DeckViewerCardManaColouringG" onmousemove="ShowTextTooltip(1, \'' +
            TotalG +
            ' Green Cards\');" onmouseout="ShowTextTooltip(0,0);">' +
            TotalG +
            "</div>";
